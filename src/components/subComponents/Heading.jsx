...
const Heaqding = () => {
    ...
    const {setInputData, inputData, searchResult,sortOption, setSortOption} = useData()
    ...
    return ( 
        <div className="max-w-[1150px] w-full mx-auto md:px-6 md:py-4">
            ...
            <div className="flex flex-col md:flex-row justify-around w-auto">
                <div className="h-auto w-[20%] relative flex">
                    ...
                    {choiceOne && <div className="w-auto h-auto bg-slate-100 absolute left-0 top-11 z-10 rounded-md py-4 px-2 shadow-sm">
                        <div className="flex items-center my-2">
                            <input type="radio" value='az' checked={sortOption === 'az'} onChange={() => setSortOption('az')} name="alphabetical" id="" />
                            <span className="text-[12px] mx-2">Alphabetical   A &gt;&gt; Z</span>
                        </div>
                        <div className="flex items-center my-2">
                            <input type="radio" value='za' checked={sortOption === 'za'} onChange={() => setSortOption('za')} name="alphabetical" id="" />
                            <span className="text-[12px] mx-2">Alphabetical   Z &gt;&gt; A</span>
                        </div>
                    </div>}
                </div>
                <div className="h-auto w-[20%] relative flex justify-end">
